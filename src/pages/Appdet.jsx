  ...
  return (
     <div className="card">
      ...
      <div className="loan-details">
        <div className="detail-row"><span>Service Fee:</span><strong>Ksh {fee.toFixed(2)}</strong></div>
        <div className="detail-row"><span>Interest (8%):</span><strong>Ksh {interest.toFixed(2)}</strong></div>
        <div className="detail-row"><span>Receivable Amount:</span><strong>Ksh {receivable.toFixed(2)}</strong></div>
      </div>

      <div className="mpesa-info">
        <p><strong>Mpesa Name:</strong> {name}</p>
        <p><strong>Phone:</strong> {phone}</p>
      </div>

      <button className="cta-btn" onClick={goToVerification}>Apply Now</button>
    </div>
  );
};
